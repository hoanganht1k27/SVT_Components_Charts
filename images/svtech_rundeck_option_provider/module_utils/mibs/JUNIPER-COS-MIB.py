...
# ASN.1 source file:///usr/share/snmp/mibs/mib-jnx-cos.txt
# Produced by pysmi-0.3.2 at Mon Nov  5 17:31:19 2018
...
jnxCosFcFabricPriority = MibTableColumn((1, 3, 6, 1, 4, 1, 2636, 3, 15, 3, 1, 3), Integer32().subtype(subtypeSpec=SingleValueConstraint(0, 1)).clone(namedValues=NamedValues(("low", 0), ("high", 1)))).setMaxAccess("readonly")
...
mibBuilder.exportSymbols("JUNIPER-COS-MIB", jnxCosIfqLpTcpRedDropPkts=jnxCosIfqLpTcpRedDropPkts, jnxCosInvQstatHpRedDropPkts=jnxCosInvQstatHpRedDropPkts, jnxCosIfsetQstatHpNonTcpRedDropBytes=jnxCosIfsetQstatHpNonTcpRedDropBytes, jnxCosIngressQstatMHpRedDropPkts=jnxCosIngressQstatMHpRedDropPkts, jnxCosWanQueueOverflowCleared=jnxCosWanQueueOverflowCleared, JnxCosAdminString=JnxCosAdminString, jnxCosQstatRateLimitDropByteRate=jnxCosQstatRateLimitDropByteRate, jnxCosQstatHpNonTcpRedDropPkts=jnxCosQstatHpNonTcpRedDropPkts, jnxCosInvQstatMLpRedDropPkts=jnxCosInvQstatMLpRedDropPkts, jnxCosIfsetQstatTxedByteRate=jnxCosIfsetQstatTxedByteRate, jnxCosIfqTailDropPkts=jnxCosIfqTailDropPkts, jnxCosFcIdEntry=jnxCosFcIdEntry, jnxCosIfsetQstatRateLimitDropPkts=jnxCosIfsetQstatRateLimitDropPkts, jnxCosIfqLpTcpRedDropBytes=jnxCosIfqLpTcpRedDropBytes, jnxCosIfEntry=jnxCosIfEntry, jnxCosRestrictedQNr=jnxCosRestrictedQNr, jnxCosInvQstatTailDropPkts=jnxCosInvQstatTailDropPkts, jnxCosIngressQstatQedByteRate=jnxCosIngressQstatQedByteRate, jnxCosIfsetQstatEntry=jnxCosIfsetQstatEntry, jnxCosFpcIndex=jnxCosFpcIndex, jnxCosFabricQueueOverflowCleared=jnxCosFabricQueueOverflowCleared, jnxCosQstatTotalDropPktRate=jnxCosQstatTotalDropPktRate, jnxCosIngressQstatMHpRedDropBytes=jnxCosIngressQstatMHpRedDropBytes, jnxCosIfsetQstatQedByteRate=jnxCosIfsetQstatQedByteRate, jnxCosIfqFc=jnxCosIfqFc, jnxCosInvQstatHpRedDropPktRate=jnxCosInvQstatHpRedDropPktRate, jnxCosIngressQstatLpRedDropBytes=jnxCosIngressQstatLpRedDropBytes, jnxCosQstatMLpRedDropByteRate=jnxCosQstatMLpRedDropByteRate, jnxCosIfqHpTcpRedDropBytes=jnxCosIfqHpTcpRedDropBytes, jnxCosIfqTxedByteRate=jnxCosIfqTxedByteRate, jnxCosNotificationsPrefix=jnxCosNotificationsPrefix, jnxCosIngressQstatTotalRedDropPkts=jnxCosIngressQstatTotalRedDropPkts, jnxCosQstatLpNonTcpRedDropBytes=jnxCosQstatLpNonTcpRedDropBytes, jnxCosIfqStatsEntry=jnxCosIfqStatsEntry, jnxCosIngressQstatMHpRedDropByteRate=jnxCosIngressQstatMHpRedDropByteRate, jnxCosFcIdTable=jnxCosFcIdTable, jnxCosIfsetQstatLpTcpRedDropBytes=jnxCosIfsetQstatLpTcpRedDropBytes, jnxCosIfsetQstatTxedPkts=jnxCosIfsetQstatTxedPkts, jnxCosInvQstatHpRedDropByteRate=jnxCosInvQstatHpRedDropByteRate, jnxCosIngressQstatTailDropPkts=jnxCosIngressQstatTailDropPkts, jnxCosInvQstatHpNonTcpRDropPktRate=jnxCosInvQstatHpNonTcpRDropPktRate, jnxCosQstatLpTcpRedDropByteRate=jnxCosQstatLpTcpRedDropByteRate, jnxCosIngressQstatDepthMax=jnxCosIngressQstatDepthMax, jnxCosIfqLpTcpRedDropByteRate=jnxCosIfqLpTcpRedDropByteRate, jnxCosInvQstatTxedByteRate=jnxCosInvQstatTxedByteRate, jnxCosIfsetQstatChildIfIndex=jnxCosIfsetQstatChildIfIndex, jnxCosIfsetQstatTotalRedDropBytes=jnxCosIfsetQstatTotalRedDropBytes, jnxCosQstatTotalRedDropPkts=jnxCosQstatTotalRedDropPkts, jnxCosFcFabricPriority=jnxCosFcFabricPriority, jnxCosIngressQstatTailDropPktRate=jnxCosIngressQstatTailDropPktRate, jnxCosIfsetQstatTailDropPkts=jnxCosIfsetQstatTailDropPkts, jnxCosQstatHpRedDropPktRate=jnxCosQstatHpRedDropPktRate, jnxCosInvQstatQueueNr=jnxCosInvQstatQueueNr, jnxCosFcId=jnxCosFcId, jnxCosIfsetQstatMLpRedDropByteRate=jnxCosIfsetQstatMLpRedDropByteRate, jnxCosInvQstatTable=jnxCosInvQstatTable, jnxCosIngressQstatHpTcpRedDropByteRate=jnxCosIngressQstatHpTcpRedDropByteRate, jnxCosInvQstatQedBytes=jnxCosInvQstatQedBytes, jnxCosQstatMHpRedDropPkts=jnxCosQstatMHpRedDropPkts, jnxCosIngressQstatQedBytes=jnxCosIngressQstatQedBytes, jnxCosInvQstatLpNonTcpRDropPktRate=jnxCosInvQstatLpNonTcpRDropPktRate, jnxCosQstatHpTcpRedDropPktRate=jnxCosQstatHpTcpRedDropPktRate, jnxCosInvQstatHpNonTcpRedDropBytes=jnxCosInvQstatHpNonTcpRedDropBytes, jnxCosInvQstatHpTcpRedDropByteRate=jnxCosInvQstatHpTcpRedDropByteRate, jnxCosInvQstatLpNonTcpRedDropPkts=jnxCosInvQstatLpNonTcpRedDropPkts, jnxCosQstatTotalDropByteRate=jnxCosQstatTotalDropByteRate, jnxCosQstatHpTcpRedDropBytes=jnxCosQstatHpTcpRedDropBytes, jnxCosIfIdx=jnxCosIfIdx, jnxCosIfqTotalRedDropBytes=jnxCosIfqTotalRedDropBytes, jnxCosIngressQstatLpTcpRedDropBytes=jnxCosIngressQstatLpTcpRedDropBytes, jnxCosIngressQstatDepthPeak=jnxCosIngressQstatDepthPeak, jnxCosIngressQstatTxedByteRate=jnxCosIngressQstatTxedByteRate, jnxCosQstatTxedPkts=jnxCosQstatTxedPkts, jnxCosIngressQstatLpRedDropByteRate=jnxCosIngressQstatLpRedDropByteRate, jnxCosIngressQstatDepthAverage=jnxCosIngressQstatDepthAverage, jnxCosInvQstatLpRedDropBytes=jnxCosInvQstatLpRedDropBytes, jnxCosIngressQstatTxedPkts=jnxCosIngressQstatTxedPkts, jnxCosIngressQstatTotalRedDropPktRate=jnxCosIngressQstatTotalRedDropPktRate, jnxCosInvQstatTailDropPktRate=jnxCosInvQstatTailDropPktRate, jnxCosQstatMHpRedDropPktRate=jnxCosQstatMHpRedDropPktRate, jnxCosIfsetQstatTxedBytes=jnxCosIfsetQstatTxedBytes, jnxCosQstatLpRedDropBytes=jnxCosQstatLpRedDropBytes, jnxCosIfsetQstatMHpRedDropBytes=jnxCosIfsetQstatMHpRedDropBytes, jnxCosIfqQedBytes=jnxCosIfqQedBytes, jnxCosQstatHpNonTcpRedDropBytes=jnxCosQstatHpNonTcpRedDropBytes, jnxCosQstatDepthMax=jnxCosQstatDepthMax, jnxCosIfsetQstatLpRedDropPkts=jnxCosIfsetQstatLpRedDropPkts, jnxCosIngressQstatHpNonTcpRedDropPkts=jnxCosIngressQstatHpNonTcpRedDropPkts, jnxCosInvQstatEntry=jnxCosInvQstatEntry, jnxCosInvQstatMHpRedDropByteRate=jnxCosInvQstatMHpRedDropByteRate, jnxCosIngressQstatMLpRedDropPkts=jnxCosIngressQstatMLpRedDropPkts, jnxCosInvQstatQedPkts=jnxCosInvQstatQedPkts, jnxCosInvQstatMHpRedDropPkts=jnxCosInvQstatMHpRedDropPkts, jnxCosIfqStatsTable=jnxCosIfqStatsTable, jnxCosInvQstatTotalRedDropPktRate=jnxCosInvQstatTotalRedDropPktRate, jnxCosQstatTailDropPktRate=jnxCosQstatTailDropPktRate, jnxCosQstatHpTcpRedDropByteRate=jnxCosQstatHpTcpRedDropByteRate, jnxCosWanQueueOverflow=jnxCosWanQueueOverflow, jnxCosQstatTotalRedDropPktRate=jnxCosQstatTotalRedDropPktRate, jnxCosQstatHpRedDropByteRate=jnxCosQstatHpRedDropByteRate, jnxCosIfsetQstatLpTcpRedDropPkts=jnxCosIfsetQstatLpTcpRedDropPkts, jnxCosIfsetQstatLpTcpRedDropPktRate=jnxCosIfsetQstatLpTcpRedDropPktRate, jnxCosIngressQstatMLpRedDropByteRate=jnxCosIngressQstatMLpRedDropByteRate, jnxCosIfsetQstatLpRedDropBytes=jnxCosIfsetQstatLpRedDropBytes, jnxCosIfsetDescr=jnxCosIfsetDescr, jnxCosIngressQstatEntry=jnxCosIngressQstatEntry, jnxCosQstatRateLimitDropPktRate=jnxCosQstatRateLimitDropPktRate, jnxCosQstatHpTcpRedDropPkts=jnxCosQstatHpTcpRedDropPkts, jnxCosIngressQstatTotalRedDropByteRate=jnxCosIngressQstatTotalRedDropByteRate, jnxCosIfsetQstatHpRedDropPktRate=jnxCosIfsetQstatHpRedDropPktRate, jnxCosIngressQstatHpRedDropPkts=jnxCosIngressQstatHpRedDropPkts, jnxCosIfsetQstatTable=jnxCosIfsetQstatTable, jnxCosQstatLpTcpRedDropBytes=jnxCosQstatLpTcpRedDropBytes, jnxCosIfsetQstatQueueNr=jnxCosIfsetQstatQueueNr, jnxCosNotifyVars=jnxCosNotifyVars, jnxCosInvQstatTxedBytes=jnxCosInvQstatTxedBytes, jnxCosQstatLpRedDropPktRate=jnxCosQstatLpRedDropPktRate, jnxCosInvQstatHpNonTcpRedDropPkts=jnxCosInvQstatHpNonTcpRedDropPkts, jnxCos=jnxCos, jnxCosFcQueueNr=jnxCosFcQueueNr, jnxCosIngressQstatHpTcpRedDropPkts=jnxCosIngressQstatHpTcpRedDropPkts, jnxCosIfsetQstatLpRedDropByteRate=jnxCosIfsetQstatLpRedDropByteRate, jnxCosIfsetQstatMLpRedDropPktRate=jnxCosIfsetQstatMLpRedDropPktRate, jnxCosIfsetQstatLpNonTcpRedDropBytes=jnxCosIfsetQstatLpNonTcpRedDropBytes, jnxCosIfqHpNonTcpRedDropPkts=jnxCosIfqHpNonTcpRedDropPkts, jnxCosQstatMLpRedDropBytes=jnxCosQstatMLpRedDropBytes, jnxCosIngressQstatHpNonTcpRedDropBytes=jnxCosIngressQstatHpNonTcpRedDropBytes, jnxCosIfqLpNonTcpRedDropPkts=jnxCosIfqLpNonTcpRedDropPkts, jnxCosInvQstatTxedPktRate=jnxCosInvQstatTxedPktRate, JnxCosFcIdentifier=JnxCosFcIdentifier, jnxCosIfsetQstatMHpRedDropPktRate=jnxCosIfsetQstatMHpRedDropPktRate, jnxCosInvQstatMHpRedDropBytes=jnxCosInvQstatMHpRedDropBytes, jnxCosInvQstatLpNonTcpRDropByteRate=jnxCosInvQstatLpNonTcpRDropByteRate, jnxCosQstatLpNonTcpRDropByteRate=jnxCosQstatLpNonTcpRDropByteRate, jnxCosIfIndex=jnxCosIfIndex, jnxCosInvQstatHpTcpRedDropBytes=jnxCosInvQstatHpTcpRedDropBytes, jnxCosQstatTxedBytes=jnxCosQstatTxedBytes, jnxCosIfsetQstatTotalRedDropPktRate=jnxCosIfsetQstatTotalRedDropPktRate, jnxCosIfsetQstatTotalRedDropPkts=jnxCosIfsetQstatTotalRedDropPkts, jnxCosIngressQstatHpRedDropPktRate=jnxCosIngressQstatHpRedDropPktRate, jnxCosIfqHpNonTcpRedDropBytes=jnxCosIfqHpNonTcpRedDropBytes, jnxCosInvQstatQedPktRate=jnxCosInvQstatQedPktRate, jnxCosQstatQueueNr=jnxCosQstatQueueNr, jnxCosIfqIfIndex=jnxCosIfqIfIndex, jnxCosInvQstatLpRedDropByteRate=jnxCosInvQstatLpRedDropByteRate, jnxCosQstatLpRedDropPkts=jnxCosQstatLpRedDropPkts, jnxCosIfqQedPkts=jnxCosIfqQedPkts, jnxCosIngressQstatLpTcpRedDropPkts=jnxCosIngressQstatLpTcpRedDropPkts, jnxCosInvQstatLpRedDropPktRate=jnxCosInvQstatLpRedDropPktRate, jnxCosQstatTxedPktRate=jnxCosQstatTxedPktRate, jnxCosIfqTailDropPktRate=jnxCosIfqTailDropPktRate, jnxCosIngressQstatHpRedDropBytes=jnxCosIngressQstatHpRedDropBytes, jnxCosIfqLpNonTcpRedDropBytes=jnxCosIfqLpNonTcpRedDropBytes, jnxCosIngressQstatMLpRedDropBytes=jnxCosIngressQstatMLpRedDropBytes, jnxCosQstatIfIndex=jnxCosQstatIfIndex, jnxCosIngressQstatDepthCurrent=jnxCosIngressQstatDepthCurrent, jnxCosInvQstatHpRedDropBytes=jnxCosInvQstatHpRedDropBytes, jnxCosIfsetQstatMLpRedDropPkts=jnxCosIfsetQstatMLpRedDropPkts, jnxCosInvQstatHpTcpRedDropPkts=jnxCosInvQstatHpTcpRedDropPkts, jnxCosQstatQedByteRate=jnxCosQstatQedByteRate, jnxCosQueueIndex=jnxCosQueueIndex, jnxCosQstatHpNonTcpRDropByteRate=jnxCosQstatHpNonTcpRDropByteRate, jnxCosIfsetQstatHpRedDropPkts=jnxCosIfsetQstatHpRedDropPkts, jnxCosQstatDepthPeak=jnxCosQstatDepthPeak, jnxCosIfqHpTcpRedDropPkts=jnxCosIfqHpTcpRedDropPkts, jnxCosIngressQstatHpTcpRedDropPktRate=jnxCosIngressQstatHpTcpRedDropPktRate, jnxCosIngressQstatTxedPktRate=jnxCosIngressQstatTxedPktRate, jnxCosInvQstatLpRedDropPkts=jnxCosInvQstatLpRedDropPkts, jnxCosIfsetQstatRateLimitDropByteRate=jnxCosIfsetQstatRateLimitDropByteRate, jnxCosIngressQstatLpTcpRedDropByteRate=jnxCosIngressQstatLpTcpRedDropByteRate, jnxCosInvQstatLpTcpRedDropPkts=jnxCosInvQstatLpTcpRedDropPkts, jnxCosIngressQstatLpNonTcpRDropPktRate=jnxCosIngressQstatLpNonTcpRDropPktRate, jnxCosQstatQedPktRate=jnxCosQstatQedPktRate, jnxCosIngressQstatIfIndex=jnxCosIngressQstatIfIndex, jnxCosIfsetQstatHpNonTcpRDropPktRate=jnxCosIfsetQstatHpNonTcpRDropPktRate, jnxCosIfsetQstatTotalRedDropByteRate=jnxCosIfsetQstatTotalRedDropByteRate, jnxCosFcIdToFcName=jnxCosFcIdToFcName, jnxCosIngressQstatQedPkts=jnxCosIngressQstatQedPkts, jnxCosIfsetQstatLpNonTcpRDropPktRate=jnxCosIfsetQstatLpNonTcpRDropPktRate, jnxCosQstatLpTcpRedDropPktRate=jnxCosQstatLpTcpRedDropPktRate, jnxCosIfqHpNonTcpRedDropByteRate=jnxCosIfqHpNonTcpRedDropByteRate, jnxCosInvQstatQedByteRate=jnxCosInvQstatQedByteRate, jnxCosIfsetQstatMHpRedDropPkts=jnxCosIfsetQstatMHpRedDropPkts, jnxCosIfsetQstatLpNonTcpRedDropPkts=jnxCosIfsetQstatLpNonTcpRedDropPkts, jnxCosIfsetQstatHpTcpRedDropPktRate=jnxCosIfsetQstatHpTcpRedDropPktRate, jnxCosQstatTxedByteRate=jnxCosQstatTxedByteRate, jnxCosFcTable=jnxCosFcTable, jnxCosOutOfDedicatedQueues=jnxCosOutOfDedicatedQueues, jnxCosQstatMLpRedDropPkts=jnxCosQstatMLpRedDropPkts, jnxCosIngressQstatTotalRedDropBytes=jnxCosIngressQstatTotalRedDropBytes, jnxCosIfsetQstatQedBytes=jnxCosIfsetQstatQedBytes, jnxCosIngressQstatHpRedDropByteRate=jnxCosIngressQstatHpRedDropByteRate, jnxCosQstatLpRedDropByteRate=jnxCosQstatLpRedDropByteRate, jnxCosIfqHpTcpRedDropPktRate=jnxCosIfqHpTcpRedDropPktRate, jnxCosInterfaceName=jnxCosInterfaceName, jnxCosIngressQstatHpNonTcpRDropPktRate=jnxCosIngressQstatHpNonTcpRDropPktRate, jnxCosIfsetQstatHpTcpRedDropPkts=jnxCosIfsetQstatHpTcpRedDropPkts, jnxCosIfstatFlags=jnxCosIfstatFlags, PYSNMP_MODULE_ID=jnxCos, jnxCosIfqHpTcpRedDropByteRate=jnxCosIfqHpTcpRedDropByteRate, jnxCosIfqLpNonTcpRedDropPktRate=jnxCosIfqLpNonTcpRedDropPktRate, jnxCosInvQstatHpTcpRedDropPktRate=jnxCosInvQstatHpTcpRedDropPktRate, jnxCosQstatMHpRedDropBytes=jnxCosQstatMHpRedDropBytes, jnxCosIfqLpTcpRedDropPktRate=jnxCosIfqLpTcpRedDropPktRate, jnxCosPfeIndex=jnxCosPfeIndex, jnxCosQstatTotalRedDropByteRate=jnxCosQstatTotalRedDropByteRate, jnxCosIngressQstatHpTcpRedDropBytes=jnxCosIngressQstatHpTcpRedDropBytes, jnxCosInvQstatLpTcpRedDropPktRate=jnxCosInvQstatLpTcpRedDropPktRate, jnxCosInvQstatMLpRedDropBytes=jnxCosInvQstatMLpRedDropBytes, jnxCosAlmostOutOfDedicatedQueues=jnxCosAlmostOutOfDedicatedQueues, jnxCosQstatMLpRedDropPktRate=jnxCosQstatMLpRedDropPktRate, jnxCosIfqTotalRedDropPktRate=jnxCosIfqTotalRedDropPktRate, jnxCosInvQstatMLpRedDropByteRate=jnxCosInvQstatMLpRedDropByteRate, jnxCosIfsetQstatLpRedDropPktRate=jnxCosIfsetQstatLpRedDropPktRate, jnxCosIngressQstatLpRedDropPktRate=jnxCosIngressQstatLpRedDropPktRate, jnxCosIngressQstatTxedBytes=jnxCosIngressQstatTxedBytes, jnxCosInvQstatTxedPkts=jnxCosInvQstatTxedPkts, jnxCosIfsetQstatQedPktRate=jnxCosIfsetQstatQedPktRate, jnxCosIfsetQstatHpTcpRedDropByteRate=jnxCosIfsetQstatHpTcpRedDropByteRate, jnxCosIngressQstatMHpRedDropPktRate=jnxCosIngressQstatMHpRedDropPktRate, jnxCosFcEntry=jnxCosFcEntry, jnxCosQstatTotalRedDropBytes=jnxCosQstatTotalRedDropBytes, jnxCosQstatTable=jnxCosQstatTable, jnxCosInvQstatIfIndex=jnxCosInvQstatIfIndex, jnxCosQstatMHpRedDropByteRate=jnxCosQstatMHpRedDropByteRate, jnxCosIfqTotalRedDropPkts=jnxCosIfqTotalRedDropPkts, jnxCosIngressQstatMLpRedDropPktRate=jnxCosIngressQstatMLpRedDropPktRate, jnxCosQstatEntry=jnxCosQstatEntry, jnxCosIfqQedByteRate=jnxCosIfqQedByteRate, jnxCosIfqTxedPktRate=jnxCosIfqTxedPktRate, jnxCosIngressQstatLpTcpRedDropPktRate=jnxCosIngressQstatLpTcpRedDropPktRate, jnxCosQstatHpNonTcpRDropPktRate=jnxCosQstatHpNonTcpRDropPktRate, JnxCosIfstatFlags=JnxCosIfstatFlags, jnxCosQstatLpNonTcpRDropPktRate=jnxCosQstatLpNonTcpRDropPktRate, jnxCosIfsetQstatRateLimitDropPktRate=jnxCosIfsetQstatRateLimitDropPktRate, jnxCosQstatTailDropPkts=jnxCosQstatTailDropPkts, jnxCosIfsetQstatHpNonTcpRedDropPkts=jnxCosIfsetQstatHpNonTcpRedDropPkts, jnxCosQstatQedBytes=jnxCosQstatQedBytes, jnxCosIngressQstatQueueNr=jnxCosIngressQstatQueueNr, jnxCosIfsetQstatHpRedDropBytes=jnxCosIfsetQstatHpRedDropBytes, jnxCosIfqTxedPkts=jnxCosIfqTxedPkts, jnxCosIfsetQstatTxedPktRate=jnxCosIfsetQstatTxedPktRate, jnxCosInvQstatLpNonTcpRedDropBytes=jnxCosInvQstatLpNonTcpRedDropBytes, jnxCosQstatLpNonTcpRedDropPkts=jnxCosQstatLpNonTcpRedDropPkts, jnxCosIfsetQstatRateLimitDropBytes=jnxCosIfsetQstatRateLimitDropBytes, jnxCosQstatRateLimitDropPkts=jnxCosQstatRateLimitDropPkts, jnxCosQstatTotalDropBytes=jnxCosQstatTotalDropBytes, jnxCosIngressQstatHpNonTcpRDropByteRate=jnxCosIngressQstatHpNonTcpRDropByteRate, jnxCosIngressQstatLpNonTcpRedDropPkts=jnxCosIngressQstatLpNonTcpRedDropPkts, jnxCosQstatDepthAverage=jnxCosQstatDepthAverage, jnxCosQstatTotalDropPkts=jnxCosQstatTotalDropPkts, jnxCosIfsetQstatQedPkts=jnxCosIfsetQstatQedPkts, jnxCosInvQstatMHpRedDropPktRate=jnxCosInvQstatMHpRedDropPktRate, jnxCosInvQstatTotalRedDropByteRate=jnxCosInvQstatTotalRedDropByteRate)
mibBuilder.exportSymbols("JUNIPER-COS-MIB", jnxCosIfsetQstatLpNonTcpRDropByteRate=jnxCosIfsetQstatLpNonTcpRDropByteRate, jnxCosQstatLpTcpRedDropPkts=jnxCosQstatLpTcpRedDropPkts, jnxCosIfsetQstatLpTcpRedDropByteRate=jnxCosIfsetQstatLpTcpRedDropByteRate, jnxCosInvQstatHpNonTcpRDropByteRate=jnxCosInvQstatHpNonTcpRDropByteRate, jnxCosQstatHpRedDropPkts=jnxCosQstatHpRedDropPkts, jnxCosIfsetQstatHpRedDropByteRate=jnxCosIfsetQstatHpRedDropByteRate, jnxCosIngressQstatLpRedDropPkts=jnxCosIngressQstatLpRedDropPkts, jnxCosFcName=jnxCosFcName, jnxCosIfstatFlagTable=jnxCosIfstatFlagTable, jnxCosQstatDepthCurrent=jnxCosQstatDepthCurrent, jnxCosIfsetQstatMHpRedDropByteRate=jnxCosIfsetQstatMHpRedDropByteRate, jnxCosQstatRateLimitDropBytes=jnxCosQstatRateLimitDropBytes, jnxCosInvQstatMLpRedDropPktRate=jnxCosInvQstatMLpRedDropPktRate, jnxCosIfqLpNonTcpRedDropByteRate=jnxCosIfqLpNonTcpRedDropByteRate, jnxCosInvQstatTotalRedDropBytes=jnxCosInvQstatTotalRedDropBytes, jnxCosIfsetQstatTailDropPktRate=jnxCosIfsetQstatTailDropPktRate, jnxCosIfqTxedBytes=jnxCosIfqTxedBytes, jnxCosIngressQstatTable=jnxCosIngressQstatTable, jnxCosIfqHpNonTcpRedDropPktRate=jnxCosIfqHpNonTcpRedDropPktRate, jnxCosIngressQstatLpNonTcpRedDropBytes=jnxCosIngressQstatLpNonTcpRedDropBytes, jnxCosInvQstatTotalRedDropPkts=jnxCosInvQstatTotalRedDropPkts, jnxCosInvQstatLpTcpRedDropByteRate=jnxCosInvQstatLpTcpRedDropByteRate, jnxCosIfsetQstatHpNonTcpRDropByteRate=jnxCosIfsetQstatHpNonTcpRDropByteRate, jnxCosIfqQedPktRate=jnxCosIfqQedPktRate, jnxCosIngressQstatQedPktRate=jnxCosIngressQstatQedPktRate, jnxCosQstatHpRedDropBytes=jnxCosQstatHpRedDropBytes, jnxCosFabricQueueOverflow=jnxCosFabricQueueOverflow, jnxCosIfsetQstatMLpRedDropBytes=jnxCosIfsetQstatMLpRedDropBytes, jnxCosIfstatFlagEntry=jnxCosIfstatFlagEntry, jnxCosQstatQedPkts=jnxCosQstatQedPkts, jnxCosIfqTotalRedDropByteRate=jnxCosIfqTotalRedDropByteRate, jnxCosIfTable=jnxCosIfTable, jnxCosIfsetQstatHpTcpRedDropBytes=jnxCosIfsetQstatHpTcpRedDropBytes, jnxCosInvQstatLpTcpRedDropBytes=jnxCosInvQstatLpTcpRedDropBytes, jnxCosIngressQstatLpNonTcpRDropByteRate=jnxCosIngressQstatLpNonTcpRDropByteRate)
