...
# ASN.1 source file:///usr/share/snmp/mibs/mib-jnx-ping.txt
# Produced by pysmi-0.3.2 at Mon Nov  5 17:37:37 2018
...
pingCtlTargetAddress, OperationResponseStatus, pingCtlTargetAddressType, pingResultsLastGoodProbe, pingResultsIpTargetAddressType, pingResultsEntry, pingProbeHistoryEntry, pingResultsProbeResponses, pingResultsRttSumOfSquares, pingResultsSentProbes, pingResultsMinRtt, pingResultsOperStatus, pingResultsMaxRtt, pingResultsIpTargetAddress, pingResultsAverageRtt = mibBuilder.importSymbols("DISMAN-PING-MIB", "pingCtlTargetAddress", "OperationResponseStatus", "pingCtlTargetAddressType", "pingResultsLastGoodProbe", "pingResultsIpTargetAddressType", "pingResultsEntry", "pingProbeHistoryEntry", "pingResultsProbeResponses", "pingResultsRttSumOfSquares", "pingResultsSentProbes", "pingResultsMinRtt", "pingResultsOperStatus", "pingResultsMaxRtt", "pingResultsIpTargetAddress", "pingResultsAverageRtt")
...
mibBuilder.exportSymbols("JUNIPER-PING-MIB", jnxPingLastTestResultMinIngressUs=jnxPingLastTestResultMinIngressUs, jnxPingResultsOwnerIndex=jnxPingResultsOwnerIndex, jnxPingCtlRoutingIfIndex=jnxPingCtlRoutingIfIndex, jnxPingProbeHistoryTable=jnxPingProbeHistoryTable, jnxPingResultsStddevEgressUs=jnxPingResultsStddevEgressUs, jnxPingResultsStatus=jnxPingResultsStatus, jnxPingNtpQuery=jnxPingNtpQuery, jnxPingResultsRttUs=jnxPingResultsRttUs, jnxPingLastTestResultAvgRttUs=jnxPingLastTestResultAvgRttUs, jnxPingLastTestResultPeakToPeakJitterRttUs=jnxPingLastTestResultPeakToPeakJitterRttUs, jnxPingIcmpTimeStamp=jnxPingIcmpTimeStamp, jnxPingIngressStddevThresholdExceeded=jnxPingIngressStddevThresholdExceeded, jnxPingLastTestResultPeakToPeakJitterEgressUs=jnxPingLastTestResultPeakToPeakJitterEgressUs, jnxPingResultsTime=jnxPingResultsTime, jnxPingCtlRttJitterThreshold=jnxPingCtlRttJitterThreshold, jnxPingLastTestResultTable=jnxPingLastTestResultTable, jnxPingCtlTrapGeneration=jnxPingCtlTrapGeneration, jnxPingResultsMinRttUs=jnxPingResultsMinRttUs, jnxPingLastTestResultMaxEgressUs=jnxPingLastTestResultMaxEgressUs, jnxPingResultsMinIngressUs=jnxPingResultsMinIngressUs, jnxPingProbeHistoryResponseEgressUs=jnxPingProbeHistoryResponseEgressUs, jnxPingResultsSumRttUs=jnxPingResultsSumRttUs, jnxPingMIB=jnxPingMIB, jnxPingCtlIfName=jnxPingCtlIfName, jnxPingLastTestResultTime=jnxPingLastTestResultTime, jnxPingEgressThresholdExceeded=jnxPingEgressThresholdExceeded, jnxPingCtlEXseriesHWTimeStamp=jnxPingCtlEXseriesHWTimeStamp, jnxPingNotificationPrefix=jnxPingNotificationPrefix, jnxPingProbeHistoryEgressJitterUs=jnxPingProbeHistoryEgressJitterUs, jnxPingCtlMovAvgSize=jnxPingCtlMovAvgSize, jnxPingResultsEntry=jnxPingResultsEntry, jnxPingHttpGetMetadata=jnxPingHttpGetMetadata, jnxPingLastTestResultSumRttUs=jnxPingLastTestResultSumRttUs, jnxPingCtlTargetPort=jnxPingCtlTargetPort, jnxPingRttStdDevThresholdExceeded=jnxPingRttStdDevThresholdExceeded, jnxPingLastTestResultMinRttUs=jnxPingLastTestResultMinRttUs, jnxPingUdpTimestamp=jnxPingUdpTimestamp, jnxPingLastTestResultStdDevRttUs=jnxPingLastTestResultStdDevRttUs, jnxPingProbeHistoryResponseIngressUs=jnxPingProbeHistoryResponseIngressUs, jnxPingLastTestResultAvgIngressUs=jnxPingLastTestResultAvgIngressUs, jnxPingCtlIngressStddevThreshold=jnxPingCtlIngressStddevThreshold, jnxPingCtlMXseriesHWTimeStamp=jnxPingCtlMXseriesHWTimeStamp, jnxPingLastTestResultMaxRttUs=jnxPingLastTestResultMaxRttUs, jnxPingObjects=jnxPingObjects, jnxPingResultsAvgEgressUs=jnxPingResultsAvgEgressUs, jnxPingDnsQuery=jnxPingDnsQuery, jnxPingResultsMaxRttUs=jnxPingResultsMaxRttUs, jnxPingResultsJitterIngressUs=jnxPingResultsJitterIngressUs, jnxPingProbeHistoryJitterUs=jnxPingProbeHistoryJitterUs, jnxPingResultsEgressUs=jnxPingResultsEgressUs, jnxPingResultsAvgRttUs=jnxPingResultsAvgRttUs, jnxPingCtlTable=jnxPingCtlTable, jnxPingLastTestResultMinEgressUs=jnxPingLastTestResultMinEgressUs, jnxPingResultsIngressUs=jnxPingResultsIngressUs, jnxPingHttpGet=jnxPingHttpGet, jnxPingEgressStdDevThresholdExceeded=jnxPingEgressStdDevThresholdExceeded, jnxPingCtlJseriesHWTimeStamp=jnxPingCtlJseriesHWTimeStamp, jnxPingResultsMinEgressUs=jnxPingResultsMinEgressUs, jnxPingCtlIngressTimeThreshold=jnxPingCtlIngressTimeThreshold, jnxPingResultsTable=jnxPingResultsTable, jnxPingProbeHistoryEntry=jnxPingProbeHistoryEntry, jnxPingCtlEgressStdDevThreshold=jnxPingCtlEgressStdDevThreshold, jnxPingRttThresholdExceeded=jnxPingRttThresholdExceeded, jnxPingLastTestResultStddevIngressUs=jnxPingLastTestResultStddevIngressUs, jnxPingResultsStddevIngressUs=jnxPingResultsStddevIngressUs, jnxPingProbeHistoryIngressJitterUs=jnxPingProbeHistoryIngressJitterUs, jnxPingResultsJitterRttUs=jnxPingResultsJitterRttUs, jnxPingCtlOwnerIndex=jnxPingCtlOwnerIndex, jnxPingLastTestResultEntry=jnxPingLastTestResultEntry, jnxPingCtlOneWayHWTimeStamp=jnxPingCtlOneWayHWTimeStamp, jnxPingLastTestResultProbeResponses=jnxPingLastTestResultProbeResponses, jnxPingLastTestResultSentProbes=jnxPingLastTestResultSentProbes, jnxPingResultsAvgIngressUs=jnxPingResultsAvgIngressUs, jnxPingCtlRttThreshold=jnxPingCtlRttThreshold, jnxPingCtlRoutingInstanceName=jnxPingCtlRoutingInstanceName, jnxPingCtlEgressJitterThreshold=jnxPingCtlEgressJitterThreshold, jnxPingCtlEntry=jnxPingCtlEntry, jnxPingResultsJitterEgressUs=jnxPingResultsJitterEgressUs, jnxPingCtlRttStdDevThreshold=jnxPingCtlRttStdDevThreshold, jnxPingRttJitterThresholdExceeded=jnxPingRttJitterThresholdExceeded, jnxPingCtlIngressJitterThreshold=jnxPingCtlIngressJitterThreshold, jnxPingImplementationTypeDomains=jnxPingImplementationTypeDomains, jnxPingCtlEgressTimeThreshold=jnxPingCtlEgressTimeThreshold, jnxPingProbeHistoryResponseUs=jnxPingProbeHistoryResponseUs, jnxPingEgressJitterThresholdExceeded=jnxPingEgressJitterThresholdExceeded, jnxPingResultsTestName=jnxPingResultsTestName, jnxPingCtlTestName=jnxPingCtlTestName, jnxPingLastTestResultStddevEgressUs=jnxPingLastTestResultStddevEgressUs, PYSNMP_MODULE_ID=jnxPingMIB, jnxPingResultsStdDevRttUs=jnxPingResultsStdDevRttUs, jnxPingLastTestResultPeakToPeakJitterIngressUs=jnxPingLastTestResultPeakToPeakJitterIngressUs, jnxPingResultsMaxEgressUs=jnxPingResultsMaxEgressUs, jnxPingLastTestResultAvgEgressUs=jnxPingLastTestResultAvgEgressUs, jnxPingResultsMaxIngressUs=jnxPingResultsMaxIngressUs, jnxPingCtlRoutingIfName=jnxPingCtlRoutingIfName, jnxPingIngressThresholdExceeded=jnxPingIngressThresholdExceeded, jnxPingLastTestResultMaxIngressUs=jnxPingLastTestResultMaxIngressUs, jnxPingIngressJitterThresholdExceeded=jnxPingIngressJitterThresholdExceeded)
