...
# ASN.1 source file:///usr/share/snmp/mibs/ietf/OSPF-MIB
# Produced by pysmi-0.3.4 at Mon Feb 24 16:07:37 2020
# On host kien-HP-ProBook-440-G5 platform Linux version 5.3.0-40-generic by user kien
...
Integer32, Bits, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Counter64, mib_2, MibIdentifier, ObjectIdentity, ModuleIdentity, IpAddress, iso, Counter32, Unsigned32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Bits", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Counter64", "mib-2", "MibIdentifier", "ObjectIdentity", "ModuleIdentity", "IpAddress", "iso", "Counter32", "Unsigned32", "TimeTicks")
...
mibBuilder.exportSymbols("OSPF-MIB", ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfRxNewLsas=ospfRxNewLsas, ospfBasicGroup=ospfBasicGroup, ospfNbrState=ospfNbrState, ospfTOSSupport=ospfTOSSupport, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfLsdbTable=ospfLsdbTable, ospfLsdbType=ospfLsdbType, ospfHostIpAddress=ospfHostIpAddress, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, Metric=Metric, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfLsdbSequence=ospfLsdbSequence, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfAreaRangeNet=ospfAreaRangeNet, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfIfTable=ospfIfTable, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfNbrIpAddr=ospfNbrIpAddr, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfHostGroup2=ospfHostGroup2, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfAuthType=ospfAuthType, ospfRestartInterval=ospfRestartInterval, ospfVirtIfEvents=ospfVirtIfEvents, ospfLsdbAge=ospfLsdbAge, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfRestartAge=ospfRestartAge, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfSpfRuns=ospfSpfRuns, ospfAreaLsaCount=ospfAreaLsaCount, ospfLsdbLsid=ospfLsdbLsid, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfIntraArea=ospfIntraArea, ospfExtLsdbTable=ospfExtLsdbTable, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfRestartSupport=ospfRestartSupport, ospfHostAreaID=ospfHostAreaID, ospfHostMetric=ospfHostMetric, ospfStubMetricType=ospfStubMetricType, ospfIfRetransInterval=ospfIfRetransInterval, PYSNMP_MODULE_ID=ospf, ospfAsLsdbAge=ospfAsLsdbAge, ospfLsdbEntry=ospfLsdbEntry, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, Status=Status, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfIfAuthType=ospfIfAuthType, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfObsoleteGroup=ospfObsoleteGroup, ospf=ospf, ospfLsdbRouterId=ospfLsdbRouterId, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfIfHelloInterval=ospfIfHelloInterval, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfAdminStat=ospfAdminStat, ospfAreaSummary=ospfAreaSummary, DesignatedRouterPriority=DesignatedRouterPriority, PositiveInteger=PositiveInteger, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfRestartStatus=ospfRestartStatus, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfImportAsExtern=ospfImportAsExtern, ospfExternalType1=ospfExternalType1, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfNbrTable=ospfNbrTable, ospfIfState=ospfIfState, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, AreaID=AreaID, ospfRestartExitReason=ospfRestartExitReason, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfIfEvents=ospfIfEvents, ospfGroups=ospfGroups, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfExternalType2=ospfExternalType2, ospfIfMetricGroup=ospfIfMetricGroup, ospfExtLsdbAge=ospfExtLsdbAge, ospfAreaStatus=ospfAreaStatus, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfVersionNumber=ospfVersionNumber, ospfStubStatus=ospfStubStatus, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfIfMetricTOS=ospfIfMetricTOS, ospfGeneralGroup=ospfGeneralGroup, ospfMulticastExtensions=ospfMulticastExtensions, ospfIfMetricStatus=ospfIfMetricStatus, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfStubTOS=ospfStubTOS, ospfAreaRangeEntry=ospfAreaRangeEntry, HelloRange=HelloRange, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfNbrPriority=ospfNbrPriority, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfHostGroup=ospfHostGroup, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfLsdbChecksum=ospfLsdbChecksum, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfIfMetricTable=ospfIfMetricTable, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfNbrEvents=ospfNbrEvents, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfAsLsdbTable=ospfAsLsdbTable, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfNbrGroup2=ospfNbrGroup2, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfNbrEntry=ospfNbrEntry, ospfConformance=ospfConformance, UpToMaxAge=UpToMaxAge, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfInterArea=ospfInterArea, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfBasicGroup2=ospfBasicGroup2, ospfComplianceObsolete=ospfComplianceObsolete, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfLocalLsdbType=ospfLocalLsdbType, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, RouterID=RouterID, ospfHostEntry=ospfHostEntry, ospfVirtNbrState=ospfVirtNbrState, ospfIfIpAddress=ospfIfIpAddress, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfAsLsaCount=ospfAsLsaCount, ospfAreaRangeTable=ospfAreaRangeTable, ospfIfTransitDelay=ospfIfTransitDelay, ospfHostTable=ospfHostTable, ospfIfGroup2=ospfIfGroup2, BigMetric=BigMetric, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfStubAreaTable=ospfStubAreaTable, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfCompliance2=ospfCompliance2, ospfStubAreaGroup=ospfStubAreaGroup, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfIfAdminStat=ospfIfAdminStat, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfAreaGroup2=ospfAreaGroup2, ospfAsLsdbType=ospfAsLsdbType, ospfIfRtrPriority=ospfIfRtrPriority, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfAreaGroup=ospfAreaGroup, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfIfEntry=ospfIfEntry, ospfIfPollInterval=ospfIfPollInterval, ospfVirtIfGroup=ospfVirtIfGroup, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfStubAreaId=ospfStubAreaId, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfCompliances=ospfCompliances, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfIfStatus=ospfIfStatus, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfAreaRangeMask=ospfAreaRangeMask, ospfExtLsdbType=ospfExtLsdbType, ospfAreaEntry=ospfAreaEntry, ospfVirtNbrArea=ospfVirtNbrArea, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfIfGroup=ospfIfGroup, ospfIfDemand=ospfIfDemand, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfNbrRtrId=ospfNbrRtrId, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfIfLsaCount=ospfIfLsaCount, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfStubAreaEntry=ospfStubAreaEntry, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfStubMetric=ospfStubMetric, ospfDemandExtensions=ospfDemandExtensions, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfRouteGroup=ospfRouteGroup, ospfIfAreaId=ospfIfAreaId, TOSType=TOSType, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfAddressLessIf=ospfAddressLessIf, ospfIfType=ospfIfType, ospfIfMetricValue=ospfIfMetricValue, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfNbrOptions=ospfNbrOptions, ospfVirtIfState=ospfVirtIfState, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfNbrGroup=ospfNbrGroup, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfExternLsaCount=ospfExternLsaCount, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfAreaTable=ospfAreaTable, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfLsdbGroup=ospfLsdbGroup, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfVirtIfEntry=ospfVirtIfEntry, ospfHostStatus=ospfHostStatus, ospfLocalLsdbAge=ospfLocalLsdbAge, OspfAuthenticationType=OspfAuthenticationType, ospfVirtNbrTable=ospfVirtNbrTable, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfCompliance=ospfCompliance, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfStubRouterSupport=ospfStubRouterSupport, ospfIfMetricEntry=ospfIfMetricEntry, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfAreaId=ospfAreaId, ospfRouterId=ospfRouterId, ospfIfAuthKey=ospfIfAuthKey, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfLsdbAreaId=ospfLsdbAreaId)
mibBuilder.exportSymbols("OSPF-MIB", ospfHostTOS=ospfHostTOS, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfVirtIfTable=ospfVirtIfTable, ospfVirtIfStatus=ospfVirtIfStatus)
